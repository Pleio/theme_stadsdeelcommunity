...
.elgg-button-submit {
	...
	border: 1px solid #<?php echo COLOR_ANCHORS;?>;
	background: #<?php echo COLOR_ANCHORS;?> url(<?php echo elgg_get_site_url(); ?>_graphics/button_graduation.png) repeat-x left 10px;
}

.elgg-button-submit:hover {
	text-decoration: none;
	color: white;
	background: #999 url(<?php echo elgg_get_site_url(); ?>_graphics/button_graduation.png) repeat-x left 10px;
}
...
.elgg-button-dropdown {
	...
	background-color: #<?php echo COLOR_BASIC; ?>;
}
...
.elgg-button-dropdown.elgg-state-active {
	background: #<?php echo COLOR_WIDGET_HEADER; ?>;
	outline: none;
	color: #333;
